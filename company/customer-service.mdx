...
The Service Provider guarantees a monthly uptime of 99%.
...
### 2.2 Downtime
Downtime refers to any period during which the Service service is unavailable or inaccessible due to issues on the Service Provider's side.
...
- **<90% uptime:** 20% of the monthly subscription fee.
...
This SLA reflects the service provider’s commitment to delivering high-quality and reliable Service services. By using our Services, the Service Recipient agrees to the terms and conditions outlined in this SLA.
