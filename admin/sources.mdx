...
Babbage Insight uses *["Powered by Fivetran" Connect Cards](https://www.fivetran.com/use-case/operations/embedded)* to have the
administrator enter the source data's connectivity details. **User Credentials are NOT transmitted to or stored on Babbage Insight's servers.** 
