...
<div style={{ width: '100%', height: 'auto', maxHeight: '500px' }}>
  <img src="assets/dashboard/my-report.png" style={{ width: '100%', height: 'auto' }} />
</div>
...
<div style="display: flex; justify-content: center; margin-top: 20px;">
  <a href="mailto:team@babbageinsight.com" style="padding: 10px 20px; color: #ffffff; background-color: #ff0000; text-decoration: none; border-radius: 0px;">Get In Touch!</a>
</div>
