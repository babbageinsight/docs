...
These are some (but not all!) of the items in Babbage Insight's short-term
roadmap. (A few in **bold** are high priority.)
...
| Insights                   | **Insight Flow** | Carefully curate a streamlined narrative that evolves with your data.  You only ever see only the most relevant and impactful insights.|
...
| LLMs                       | Alternate Providers | Support for other common and prominent LLM providers such as Anthropic's Claude.|
...
| Metrics                    | Auto Metrics | Babbage Insight will scan your data source and automatically suggest the high-level metrics that are relevant to your data, along with the SQL to query them.|
...
| Metrics                    | SQL Validation | Run sample queries against your data source to ensure that they are valid, while saving the metric.|